...
def process_dataset(dataset_path, target_column):
    ...
    out_folder = os.path.join('/home/aghasemi/CompBio481/feature_selection/feat_select_res_branch1_sex_specific_p2', os.path.basename(dataset_path).replace(".csv", ""))
